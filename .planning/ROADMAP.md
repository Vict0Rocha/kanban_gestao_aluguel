...
**Goal:** O gestor digita um termo num campo de busca ao vivo — o mesmo `SearchField` já usado no Board e no relatório "Situação dos contratos" — e a listagem de `/financeiro/configuracao` filtra de verdade por número do contrato, endereço e proprietário, sem round-trip ao servidor e sem quebrar a paginação já existente
**Requirements**: FILTCFG-01, FILTCFG-02, FILTCFG-03, FILTCFG-04 (trabalho pós-milestone — ver 18-CONTEXT.md)
**Depends on:** Phase 17
**Success Criteria** (what must be TRUE):
